...
const InputSearch = (props: any) => {
    return (
        <div className="p-8 flex flex-col sm:flex-row items-center justify-center bg-white rounded-xl ring-1 ring-gray-100 shadow">
            ...
            <div className="w-full max-w-xs mx-auto mt-6 sm:mt-0 flex sm:justify-center justify-start">
                {props.children}
            </div>
        </div>
    )
