...
const DropdownMenu = () => {
    return (
        ...
        <ul>
            ...
            <li className="text-gray-900 group flex rounded-md items-center w-full px-2 py-2 text-sm hover:bg-blue-600 hover:text-white"><Link to="/stats" className="w-full">Stats</Link></li>
            <li className="text-gray-900 group flex rounded-md items-center w-full px-2 py-2 text-sm hover:bg-blue-600 hover:text-white"><Link to="/ranking" className="w-full">Ranking</Link></li>
        </ul>
           </div>
        </div>
    )
